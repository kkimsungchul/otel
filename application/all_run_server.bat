...
REM start cmd /k "cd ./otel-sdk-django-01 && start_django.bat"
REM start cmd /k "cd ./otel-sdk-flask-01 && start_sdk_flask.bat"
...
REM start cmd /k "cd ./otel-auto-django-01 && start_auto_django.bat"
REM start cmd /k "cd ./otel-auto-flask-01 && start_auto_flask.bat"
